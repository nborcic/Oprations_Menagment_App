    ...
    <aside className="w-60 bg-gray-900 text-white flex flex-col h-screen sticky top-0 flex-shrink-0">
      <div className="px-5 py-5 border-b border-gray-800">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-bold text-white leading-tight">SOMP</p>
      ...
      <div className="px-3 py-4 border-t border-gray-800">
        <div className="flex items-center gap-3 px-3 py-2 mb-1">
          <div className="w-8 h-8 bg-gray-700 rounded-full flex items-center justify-center text-sm font-semibold text-gray-300 flex-shrink-0">
            {user?.name.charAt(0)}
          </div>
